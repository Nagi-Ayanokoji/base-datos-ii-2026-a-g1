...
-- Ver matrículas del semestre 2026-1
-- SELECT e.nombre, a.codigo, m.nota_final, m.asistencia
-- FROM matricula m
...
-- SELECT 
--     semestre,
--     ROUND(AVG(nota_final)::numeric, 2) AS promedio_general,
...
-- ============================================================================
-- ¡DATOS LISTOS PARA LAS CONSULTAS DE LA ACTIVIDAD!
-- ============================================================================
